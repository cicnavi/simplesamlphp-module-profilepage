...
class RawRowResult
{
    public const CONNECTED_SERVICE = [
        ...
        ConnectedServicesTableConstants::ENTITY_CONNECTED_SERVICE_COLUMN_NAME_LAST_AUTHENTICATION_AT => 1645564942,
        ConnectedServicesTableConstants::ENTITY_CONNECTED_SERVICE_COLUMN_NAME_FIRST_AUTHENTICATION_AT => 1645564942,
    ...
    public const ACTIVITY = [
        ActivityTableConstants::ENTITY_ACTIVITY_COLUMN_NAME_HAPPENED_AT => 1645564942,
