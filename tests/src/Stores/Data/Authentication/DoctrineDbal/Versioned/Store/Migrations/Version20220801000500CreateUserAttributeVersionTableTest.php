...
/**
 * @covers \SimpleSAML\Module\accounting\Stores\Data\Authentication\DoctrineDbal\Versioned\Store\Migrations\Version20220801000500CreateUserAttributeVersionTable
 * @uses \SimpleSAML\Module\accounting\Stores\Connections\DoctrineDbal\Bases\AbstractMigration
 * @uses \SimpleSAML\Module\accounting\Stores\Connections\DoctrineDbal\Connection *
 */
class Version20220801000500CreateUserAttributeVersionTableTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tableName = 'vds_user_attribute_version';
    ...
    public function testCanRunMigration(): void
    {
        ...
        $migration = new Migrations\Version20220801000500CreateUserAttributeVersionTable($this->connection);
        $migration->run();
    ...
    public function testRunThrowsMigrationException(): void
    {
        ...
        $migration = new Migrations\Version20220801000500CreateUserAttributeVersionTable($this->connectionStub);
